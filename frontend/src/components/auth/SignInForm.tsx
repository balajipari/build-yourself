    ...
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 px-6 py-4 rounded-2xl hover:bg-gray-50 hover:border-gray-300 hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#8c52ff]/20 focus:border-[#8c52ff] group cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? (
            <div className="w-5 h-5 border-2 border-gray-300 border-t-[#8c52ff] rounded-full animate-spin"></div>
          ) : (
